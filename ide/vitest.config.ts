...
export default defineConfig({
  test: {
    ...
    include: [
      ...
      "src/ext/hooks.test.ts", "src/ext/prompt.test.ts", "src/ext/shimLang.test.ts", "src/ext/config.test.ts", "src/ext/statusBar.test.ts", "src/ext/fsWatch.test.ts", "src/ext/views.test.ts", "src/ext/workspaceEdit.test.ts", "src/ext/decorations.test.ts", "src/mcp/mcpExtras.test.ts",
      "src/theme.test.ts",
